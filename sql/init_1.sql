...
-- =====================================================================
-- BUSINESS DATABASE (DB 1)
-- Здесь хранятся только таблицы бизнес-логики.
-- Идентификаторы пользователей приходят из отдельной auth-базы и
-- поэтому хранятся как обычные INT-поля без межбазовых FK.
-- =====================================================================
